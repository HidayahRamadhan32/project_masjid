...
<body>
    <div id="header">
        <div class="container-atas">
            <nav>
              <div class="header-1">
                <img src="img/logowk.png" class="logo_1">
                <p style="font-size: 20px; text-align: left;j">SMK WIKRAMA BOGOR</p><br>
                <ul id="sidemenu">
...
<body>
  <div class="card-2">
      ...
      <h3>Total Dana Terkumpul</h3>
          <div class="value-2" id="total-dana">
                <?php
                    ...
                    $bar = ($format_nominal / $tota_harus) * 1000;
                ?>
                <?php
    ...
    <div class="display: flex; justify-content: center">
      <div class="progress-bar-2" style="width: 93%; background-color: #999999; height: 45px; border-radius: 5px; overflow: hidden; text-align: center; margin-top:">
      <div class="progress-2" style=" width: <?php echo $bar ?? 0 ?>%;"></div>
      <span class="progress-text-2" style="position: absolute; top: 1110; left: 90%; transform: translate(-50%, -50%); color: white; "><?php echo '<h1 style="color:black">' . $bar . '%<h1>'; ?></span>
    </div>
</div>
</div>
    <div class="section-2">
      <div class="spinning-text-2" id="spinning-text">
        <marquee class="text-jalan" behavior="scroll" direction="left" scrolLamount="20">
                  <?php foreach($all_data as $data) : ?>
  ...
  <br><br><br>
    ...
    <div class="header-text-1">
        ...
        <div class="card1">
    <img style = "width:100px; height:175px;" src="img/love.jpeg" alt="Logo" class="logo1">
  ...
  <div class="card1">
    <img style = "width:100px; height:175px;" src="img/centang_biru.jpeg" alt="Logo" class="logo1">
  ...
  <div class="card1">
    <img style = "width:100px; height:175px;" src="img/verifikasi.jpeg" alt="Logo" class="logo1">
  ...
  <div class="card1">
    <img style = "width:100px; height:175px;" src="img/cahaya.jpeg" alt="Logo" class="logo1">
    ...
    <?php $i = 1; ?>
        ...
        <div class="galeri"></div> 
            <div class="gallery">
              ...
              <img src="img/masjid3.jpg" alt="Above Photo 1">
              <img src="img/dalam_masjid.jpg" alt="Above Photo 2">
              <img src="img/masjid_laut.jpeg" alt="Above Photo 3">
            </div>

            <div class="gallery">
              
              <img src="img/masjid_putih.jpg" alt="Below Photo 1">
              <img src="img/mekkah.jpeg" alt="Below Photo 2">
              <a href="galeri.php"><img src="img/buka_galeri.jpeg" alt="Below Photo 3"></a>
            </div>
          <br><br><br>
